...
leResult screenShow_Screen0(void)
{
    ...
    Screen0_mchplogo->fn->setSize(Screen0_mchplogo, 96, 33);
    ...
    Screen0_mchplogo->fn->setImage(Screen0_mchplogo, (leImage*)&mchpLogo_oledc_0);
    root0->fn->addChild(root0, (leWidget*)Screen0_mchplogo);

    Screen0_txtStr1 = leTextFieldWidget_New();
    Screen0_txtStr1->fn->setPosition(Screen0_txtStr1, 0, 26);
    ...
    Screen0_txtStr1->fn->setFont(Screen0_txtStr1, (leFont*)&NotoSans_Bold);
    root0->fn->addChild(root0, (leWidget*)Screen0_txtStr1);

    Screen0_txtStr2 = leTextFieldWidget_New();
    Screen0_txtStr2->fn->setPosition(Screen0_txtStr2, 0, 58);
    Screen0_txtStr2->fn->setSize(Screen0_txtStr2, 96, 38);
